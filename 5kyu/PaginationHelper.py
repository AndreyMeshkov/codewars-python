...
class PaginationHelper:
    ...
    def page_item_count(self, page_index):
        count = len(self.collection) - page_index * self.items_per_page
    ...
    def page_index(self, item_index):
        count = int((item_index / self.items_per_page))
        return count if item_index >= 0 and item_index < len(
            self.collection) else -1
...
#             return len(
#                 self.collection) % self.items_per_page or self.items_per_page
#         else:
#             return self.items_per_page
#
#     # determines what page an item is on. Zero based indexes.
